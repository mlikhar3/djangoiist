...
class Profile(models.Model):
    ...
    avatar      = models.ImageField(upload_to='profile_pictures',default='profile/mansi.jpg',blank=True)

    #academic
    ten         = models.CharField(max_length=100,blank=True)
    tenpy       = models.CharField(max_length=100,blank=True)
    twelve      = models.CharField(max_length=100,blank=True)
    twelvepy    = models.CharField(max_length=100,blank=True)
    branch      = models.CharField(max_length=100,blank=True)
    cgpa        = models.CharField(max_length=100,blank=True)
    live_kt     = models.CharField(max_length=100,blank=True)
    dead_kt     = models.CharField(max_length=100,blank=True)
    passing_year = models.CharField(max_length=100,blank=True)
    profile     = models.TextField(max_length=4000,blank=True)
    interest    = models.TextField(max_length=4000,blank=True)
    skills      = models.TextField(max_length=4000,blank=True)
    awards      = models.TextField(max_length=4000,blank=True)
    experience  = models.TextField(max_length=4000,blank=True)
    project     = models.URLField(max_length=4000,blank=True)
    ...
    iframe_maps     = models.TextField(blank=True) 
